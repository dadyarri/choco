...
const Orders = () => {
    const { isLoading, isError, data, error } = useQuery<Order[], AxiosError>(
        "orders",
        fetchOrdersList,
    );
                            ...
                            {data?.map((order: Order) => {
                                ...
                                return (
                                    !order.deleted && (
                                        <Tr key={order.id}>
                                            <Td>
                                                {DateTime.fromISO(order.date.toString()).toFormat(
                                                    "dd.MM.yyyy",
                                                )}
                                            </Td>
                                                ...
                                                <Tr key={order.id}>
                                                    ...
                                                    <Td>
                                                        <StatefulButton
                                                            ...
                                                            clickHandler={async () => {
                                                                restoreFromDeletedMutation.mutate(
                                                                    order.id,
                                                                );
                                                            }}
                                                        />
