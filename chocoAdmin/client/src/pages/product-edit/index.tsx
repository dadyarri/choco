...
const ProductEdit = () => {
    ...
    const { isLoading, isError, data, error } = useQuery<Product, AxiosError>(
        ["product", productId],
    ...
    const categories = useQuery<ProductCategory[], AxiosError>(
        "productCategory",
    ...
    const validationSchema = Yup.object().shape({
        ...
        retailPrice: Yup.number()
            .required("Поле должно быть заполнено")
            .min(1, "Цена не должна быть меньше 1"),
    ...
    return isLoading ? (
        ...
        <div>
            <Heading as={"h1"} mb={4}>
                {data ? "Редактирование" : "Создание"} товара
            </Heading>
            <Button
                as={Link}
                colorScheme={"purple"}
                ...
                {({ errors, touched }) => (
                    <Form>
                        <VStack spacing={4} align={"flex-start"}>
                            ...
                            <FormControl
                                isInvalid={!!errors.wholesalePrice && touched.wholesalePrice}
                            >
                                <FormLabel>Оптовая цена</FormLabel>
                                <InputGroup>
                                    <Field as={Input} type={"number"} name={"wholesalePrice"} />
                            ...
                            <FormControl isInvalid={!!errors.retailPrice && touched.retailPrice}>
                                ...
                                <InputGroup>
                                    <Field as={Input} type={"number"} name={"retailPrice"} />
                                    <InputRightAddon>&#8381;</InputRightAddon>
                                </InputGroup>
                            ...
                            <FormControl isInvalid={!!errors.isByWeight && touched.marketId}>
                                <Field type={"checkbox"} name={"isByWeight"} as={Checkbox}>
                                    На развес?
                                </Field>
