...
const Warehouse: FC = () => {
    const productList = useQuery<Product[], AxiosError>("products", fetchProductsList);
    ...
    return productList.isLoading ? (
        ...
        <div>
            ...
            {productList.data !== undefined && productList.data.some((p) => !p.deleted) && (
                <TableContainer>
                    <Formik
                        initialValues={{ show: showWholesalePrice }}
                        onSubmit={(values) => {
                                        ...
                                        <Tr key={product.id}>
                                            ...
                                            <Td>
                                                ...
                                                {product.leftover < 0 ? (
                                                    <ImWarning
                                                        title={
                                                            "Количество товара опустилось ниже нуля"
                                                        }
                                                    />
                                                ) : null}
                                            </Td>
                                                ...
                                                <ButtonGroup>
                                                    ...
                                                    {product.marketId ? (
                                                        <Button
                                                            ...
                                                            onClick={async () => {
                                                                await goToMarketMutation.mutate(
                                                                    product.marketId,
                                                                );
                                                            }}
                                                        >
                                                ...
                                                <Td>
                                                    <ButtonGroup>
                                                        <StatefulButton
                                                            ...
                                                            clickHandler={async (_event) => {
                                                                await restoreProductMutation.mutate(
                                                                    product.id,
                                                                );
                                                            }}
                                                        />
