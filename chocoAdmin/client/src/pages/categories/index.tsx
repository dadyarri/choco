...
const ProductCategories = () => {
    const categories = useQuery<ProductCategory[], AxiosError>(
        "categories",
        productCategoryLib.getProductCategories,
    );
    const queryClient = useQueryClient();

    const deleteCategoryMutation = useMutation(
        "deleteCategory",
        (categoryId: string) => productCategoryLib.deleteProductCategory(categoryId),
        {
            onSuccess: async () => {
    ...
    const restoreCategoryMutation = useMutation(
        "restoreCategory",
        (categoryId: string) => productCategoryLib.restoreProductCategory(categoryId),
        {
            onSuccess: async () => {
                await queryClient.invalidateQueries("categories");
            },
