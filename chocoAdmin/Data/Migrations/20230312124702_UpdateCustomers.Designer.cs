...
namespace choco.Data.Migrations
{
    ...
    [Migration("20230312124702_UpdateCustomers")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("choco.Data.Models.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("ChatUri")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("choco.Data.Models.Order", b =>
                {
                    ...
                    b.HasOne("choco.Data.Models.Customer", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("choco.Data.Models.OrderAddress", b =>
                {
                    ...
                    b.HasOne("choco.Data.Models.Customer", null)
                        .WithMany("Addresses")
                        .HasForeignKey("CustomerId");
